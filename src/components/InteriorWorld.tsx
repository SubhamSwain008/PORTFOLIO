...
// ─── Wall Candle Sconce ──────────────────────────────────
function WallCandle({ position, delay = 0 }: { position: [number, number, number]; delay?: number }) {
    ...
    return (
        <group position={position}>
            ...
            <mesh ref={flameRef} position={[0, 0.35, 0.04]}>
                ...
                <meshStandardMaterial color="#ff8800" emissive="#ffaa00" emissiveIntensity={8} transparent opacity={0.9} />
            </mesh>
